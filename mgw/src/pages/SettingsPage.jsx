    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
        {[
          ...
          {
            platform: 'Spotify',
            handle: 'Mavin Grandpa Worldwide',
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 10, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#555', marginBottom: 2 }}>
                {s.platform}
              </div>
              <div style={{ fontSize: 13, color: '#EAEAEA', fontFamily: "'DM Sans', sans-serif", overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {s.handle}
              </div>
            </div>
      ...
      <div style={{
        ...
        <button
          onClick={handleCopy}
          style={{
            background: copied ? 'rgba(80,200,120,0.1)' : 'rgba(201,162,39,0.1)',
            border: copied ? '0.5px solid rgba(80,200,120,0.3)' : `0.5px solid rgba(201,162,39,0.3)`,
            color: copied ? '#5CC88A' : GOLD,
            borderRadius: 6,
            padding: '6px 14px',
            fontFamily: "'DM Sans', sans-serif",
            fontSize: 11,
